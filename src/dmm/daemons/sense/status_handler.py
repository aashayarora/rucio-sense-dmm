...
class SENSEStatusHandlerDaemon(DaemonBase):
    ...
    def _affiliate_endpoints(self, req, workflow_api):
        ...
        exploded_source_ip = self.format_ipv6(ipaddress.IPv6Network(req.src_endpoint.ip_block))
        ...
        exploded_dest_ip = self.format_ipv6(ipaddress.IPv6Network(req.dst_endpoint.ip_block))
